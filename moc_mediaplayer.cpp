...
**
** Created: Thu 28. Oct 20:51:03 2010
...
static const char qt_meta_stringdata_MediaPlayer[] = {
    ...
    "bufferStatus(int)\0openRamFile()\0"
...
int MediaPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: showContextMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 17: bufferStatus((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 18: openRamFile(); break;
        case 19: hasVideoChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 20;
    }
