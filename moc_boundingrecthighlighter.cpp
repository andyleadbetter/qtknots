...
#include "/home/andy/QtSDK/QtCreator/share/qtcreator/qml/qmljsdebugger/editor/boundingrecthighlighter.h"
...
static const char qt_meta_stringdata_QmlJSDebugger__BoundingRectHighlighter[] = {
    ...
    "\0refresh()\0animTimeout()\0"
    "itemDestroyed(QObject*)\0"
};

const QMetaObject QmlJSDebugger::BoundingRectHighlighter::staticMetaObject = {
    { &LayerItem::staticMetaObject, qt_meta_stringdata_QmlJSDebugger__BoundingRectHighlighter,
...
void *QmlJSDebugger::BoundingRectHighlighter::qt_metacast(const char *_clname)
{
    ...
    return LayerItem::qt_metacast(_clname);
}

int QmlJSDebugger::BoundingRectHighlighter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = LayerItem::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: refresh(); break;
        case 1: animTimeout(); break;
        case 2: itemDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
