 ...
 Component {
     ...
     Item {
         ...
         function photoClicked() {
             imageDetails.videoTitle = name;
             imageDetails.videoDuration = duration;
             imageDetails.videoWidth = video_width;
             imageDetails.videoHeight = video_height;
             imageDetails.videoDate = added;
         ...
         Item {
             ...
             Rectangle {
                 ...
                 Image { id: thumb; source: "http://192.168.0.28:1978/root/resource_file?type=screenshot&mid=" + id + "&mediatype=0"; x: 1; y: 1; width: 75; height: 75; smooth: true }
