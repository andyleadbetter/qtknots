...
#include "/home/andy/QtSDK/QtCreator/share/qtcreator/qml/qmljsdebugger/editor/colorpickertool.h"
...
const QMetaObject QmlJSDebugger::ColorPickerTool::staticMetaObject = {
    { &AbstractFormEditorTool::staticMetaObject, qt_meta_stringdata_QmlJSDebugger__ColorPickerTool,
      qt_meta_data_QmlJSDebugger__ColorPickerTool, 0 }
};
...
int QmlJSDebugger::ColorPickerTool::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: selectedColorChanged((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
