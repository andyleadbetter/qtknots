...
static const char qt_meta_stringdata_KnotsPlayer[] = {
    "KnotsPlayer\0\0reply\0requestFinished(QNetworkReply*)\0"
    "onPropertiesUpdated()\0"
};
...
int KnotsPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: requestFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 1: onPropertiesUpdated(); break;
        default: ;
        }
        _id -= 2;
    }
